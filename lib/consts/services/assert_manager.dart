...
// general images
  ...
  static String banner3 = "$bannersImagesPath/banner.jpg";
  static String banner4 = "$bannersImagesPath/iphone.png";
  // Categories path
  static String mobiles = "$categoriesImagesPath/mobiles.png";
  static String fashion = "$categoriesImagesPath/T-shirt.png";
  static String watch = "$categoriesImagesPath/watch.png";
  static String book = "$categoriesImagesPath/book.png";
